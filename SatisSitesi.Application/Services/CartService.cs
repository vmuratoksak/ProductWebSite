    ...
    public class CartService : ICartService
    {
        ...
        public void AddToCart(string userId, string productId)
        {
            if (string.IsNullOrEmpty(userId))
                throw new Exception("Kullanici giris yapmamis.");
        ...
        public void IncreaseQuantity(string userId, string productId)
        {
            var cart = _cartRepo.GetAll().FirstOrDefault(x => x.UserId == userId);
            if (cart == null)
                throw new Exception("Sepet bulunamadi.");

            var item = cart.Items.FirstOrDefault(i => i.ProductId == productId);
            if (item == null)
                throw new Exception("Sepet ögesi bulunamadi.");
        ...
        public List<CartModel> GetCartItems(string userId)
        {
            if (string.IsNullOrEmpty(userId))
